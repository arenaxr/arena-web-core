 ...
 *
 */
export default class WebXRCameraCapture extends EventTarget {
  /* singleton instance */
  ...
  requestCameraFrame(cvWorkerMsg = undefined, worker = undefined) {
    if (returnedBuffer)
      this.#frameGsPixels.buffer = cvWorkerMsg.grayscalePixels.buffer;
