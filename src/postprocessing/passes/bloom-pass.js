...
class BloomPass extends Pass {
	...
	constructor( strength = 1, kernelSize = 25, sigma = 4 ) {
		...
		this.renderTargetX = new THREE.WebGLRenderTarget( 1, 1, { type: THREE.HalfFloatType } ); // will be resized later
		this.renderTargetX.texture.name = 'BloomPass.x';
		this.renderTargetY = new THREE.WebGLRenderTarget( 1, 1, { type: THREE.HalfFloatType } ); // will be resized later
