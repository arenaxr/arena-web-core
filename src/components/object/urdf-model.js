...
AFRAME.registerComponent("urdf-model", {
  schema: {
    ...
    joints: {
      ...
      parse(value) {
        if (typeof value === "object" ) { return value; } // return value if already an object
  ...
  update: function (oldData) {
    ...
    if (oldData.url !== url) {
      ...
      if (AFRAME.utils.deepEqual(oldData.joints, this.data.joints) == false) this.updateJoints();
    }
  },
